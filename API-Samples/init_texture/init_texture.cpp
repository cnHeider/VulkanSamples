...
int sample_main(int argc, char *argv[]) {
    ...
    texObj.needs_staging = (!(formatProps.linearTilingFeatures & VK_FORMAT_FEATURE_SAMPLED_IMAGE_BIT)) ? true : false;
    ...
    res = vkMapMemory(info.device, texObj.needs_staging ? texObj.buffer_memory : texObj.image_memory, 0, mem_reqs.size, 0, &data);
    assert(res == VK_SUCCESS);
